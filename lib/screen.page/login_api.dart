...
import 'package:utskhairal/model/model_login.dart';
import 'package:utskhairal/screen.page/list_berita.dart';
import 'package:utskhairal/screen.page/register_api.dart';
import 'package:utskhairal/utils/session_manager.dart';
...
class _LoginApiState extends State<LoginApi> {
  ...
  Future<ModelLogin?> loginAccount() async{
    ...
    try{
      ...
      http.Response response = await http.post(Uri.parse('http://192.168.8.231/uts_mobile/login.php'),
          body: {
