...
import 'package:utskhairal/screen.page/login_api.dart';
import 'package:utskhairal/screen.page/profile_user.dart';
        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                "http://192.168.8.231/uts_mobile/image/${data?.gambar}",
                fit: BoxFit.fill,
              ),
            ),
          ),
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.8.231/uts_mobile/berita.php"),
      );
